...
export function ProductCardAddToCartButton({
  ...
  return (
    <button
      ...
      className={cx(
        "inline-flex items-center justify-center rounded-full border border-border bg-background/80 text-foreground backdrop-blur transition-[background,border-color,transform] duration-200 hover:-translate-y-px hover:border-primary hover:bg-background disabled:pointer-events-none disabled:opacity-50",
