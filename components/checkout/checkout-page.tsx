    ...
    <Container className="py-12 md:py-16">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-lg border border-border bg-surface px-6 py-24 text-center">
          ...
          <h2 className="mt-5 font-display text-2xl tracking-tight">Your cart is empty</h2>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_420px] lg:items-start">
          <form className="space-y-6" onSubmit={submitCheckout}>
            ...
            {formError || cartError ? (
              <p className="rounded border border-primary/40 bg-primary/10 p-3 text-sm text-primary">
                {formError ?? cartError}
              </p>
            ) : null}
...
function CheckoutSummary({
  ...
  return (
    <aside className="sticky top-24 rounded-lg border border-border bg-surface p-5 md:p-6">
      ...
      <div className="mt-5 rounded border border-border bg-background p-4 text-xs leading-relaxed text-muted-foreground">
...
function CheckoutConfirmation({
  ...
  return (
    <Container className="py-16">
      <div className="mx-auto max-w-3xl rounded-lg border border-border bg-surface p-6 text-center md:p-10">
        ...
        <div className="mt-8 rounded border border-border bg-background p-4 text-left">
