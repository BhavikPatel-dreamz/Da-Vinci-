  ...
  return (
    <>
      <button
        ...
        className="fixed inset-0 z-50 animate-[fade-in_200ms_ease-out_both] bg-background/70 backdrop-blur-sm"
        onClick={onClose}
        type="button"
      />
      <aside
        ...
        aria-modal="true"
        className="fixed bottom-0 right-0 top-0 z-50 flex w-full animate-[drawer-in_420ms_cubic-bezier(.22,1,.36,1)_both] flex-col border-l border-border bg-surface sm:w-[440px]"
        role="dialog"
      >
        ...
        {items.length === 0 ? (
          <div className="flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center">
            ...
            <div>
              <h3 className="font-display text-lg tracking-tight">Your cart is empty</h3>
          ...
          <>
            <div className="flex-1 space-y-5 overflow-y-auto p-6">
              {items.map((item) => {
                ...
                return (
                  <div className="grid grid-cols-[80px_1fr] gap-4" key={item.id}>
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        <div className="inline-flex h-9 items-center rounded border border-border">
                          <button
